...
print('<a href="tienda.py?prod=1">Añadir teclado a la cesta</a><br/>')
print('<a href="tienda.py?prod=2">Añadir monitor a la cesta</a><br/>')
print('<a href="tienda.py?prod=3">Añadir raton a la cesta</a><br/>')
print("<br/>")
print()
